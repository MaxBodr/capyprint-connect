...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" className="py-20 bg-gradient-to-b from-bg-[#fffbf8] to-capyprint-orange/5">
      <div className="container mx-auto px-4">
        ...
        margin: "-100px"
          ...
          {steps.map((step, index) => <motion.div key={index} className="feature-card flex flex-col items-center text-center" variants={itemVariants}>

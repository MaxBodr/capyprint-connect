...
const Partners = () => {
  const partners = [{
    name: 'ИТМО',
    logo: '/lovable-uploads/ITMO.png'
  }, {
    name: 'Ясная Поляна',
    logo: '/lovable-uploads/yasnya-polyana.png'
  }, {
    name: 'ГУАП',
    logo: '/lovable-uploads/guap.png'
  }, {
    name: 'Invelis',
    logo: '/lovable-uploads/Invelis.png'
  }];
  return <section className="bg-capyprint-background border-t border-capyprint-muted/20 py-0">
      <div className="section-container my-0">
        ...
        once: true
          ...
          once: true
              ...
              <img src={partner.logo} alt={partner.name} className="max-w-full max-h-12 object-contain filter grayscale hover:grayscale-0 transition-all duration-300" />
            </motion.div>)}
        </motion.div>
